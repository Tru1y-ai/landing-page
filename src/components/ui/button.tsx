...
const buttonVariants = cva(
  // The pressed state lives in index.css on [data-slot="button"], not here.
  // As a Tailwind arbitrary value the easing silently failed to emit — the
  // built stylesheet contained the class name and no cubic-bezier — and the
  // active:scale variant pulled in 17kB of transform machinery.
